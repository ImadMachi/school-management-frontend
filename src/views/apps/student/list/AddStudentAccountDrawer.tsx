...
// ** Actions Imports
import { addStudentAccount } from "src/store/apps/students";
// ** Types Imports
import { AppDispatch, RootState } from "src/store";
import { Avatar, Checkbox, Chip, FormControlLabel, InputAdornment } from "@mui/material";
import { useSelector } from "react-redux";

interface SidebarUpdateStudentType {
  id: number;
  open: boolean;
  toggle: () => void;
}

export interface CreateStudentAccountDto {
  email: string;
  password: string;
  profileImage?: File;
}
...
const SidebarAddStudentAccount = (props: SidebarUpdateStudentType) => {
  // ** Props
  ...
  const student = useSelector((state: RootState) => state.students.data.find((a) => a.id === id));
  ...
  return (
    ...
    >
      <Header>
        <Typography variant="h6">Ajouter Student</Typography>
        <IconButton
          size="small"
          onClick={handleClose}
...
export default SidebarAddStudentAccount;
