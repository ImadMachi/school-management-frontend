...
const MailLog = (props: MailLogType) => {
  ...
  // ** Store Vars
  const userId = useSelector((state: RootState) => state.students.selectedUserId); // Replace 'yourSlice' with the name of your slice
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {new Date(mail.createdAt).toLocaleTimeString('en-US', {
                            hour: '2-digit',
                            minute: '2-digit',
                            hour12: true
                          })}
